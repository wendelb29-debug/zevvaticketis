  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 font-inter">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-manrope font-black text-navy uppercase tracking-tighter">Link de Check-in</h1>
        <p className="text-muted font-medium">Gere e gerencie links exclusivos para sua equipe de recepção.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-2 border-line shadow-xl rounded-[32px] overflow-hidden">
          ...
          <CardContent className="p-8 space-y-8">
            <div className="space-y-4">
              <label className="text-[10px] font-black text-navy/40 uppercase tracking-widest px-1">URL de Acesso Direto</label>
              <div className="flex gap-2">
                <div className="relative flex-1 group">
                  <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-navy/20 group-focus-within:text-primary transition-colors" />
                  <Input 
                    readOnly 
                    value={checkinUrl}
                    className="h-14 pl-12 pr-4 bg-surface border-line rounded-2xl font-bold text-navy outline-none focus-visible:ring-primary/20"
                  />
                </div>
                <Button 
                  onClick={copyToClipboard}
                  className="h-14 w-14 rounded-2xl bg-white border border-line text-navy hover:bg-surface shadow-sm"
                  title="Copiar Link"
                >
            ...
            <div className="p-6 bg-slate-50 rounded-3xl border border-line space-y-4">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-navy/5 flex items-center justify-center text-navy shrink-0">
                  <ShieldCheck className="w-6 h-6" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-sm font-black text-navy uppercase">Segurança de Acesso</h4>
              ...
              <div className="pt-4 flex items-center justify-between border-t border-line">
                <p className="text-[10px] font-bold text-muted uppercase tracking-widest">Expiração: Nunca</p>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  onClick={refreshUrl}
        ...
        <Card className="border-line shadow-xl rounded-[32px] overflow-hidden bg-surface/30">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg font-manrope font-black text-navy flex items-center gap-2">
              <Smartphone className="w-5 h-5 text-coral" /> Mobile Setup
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="aspect-square bg-white rounded-3xl border border-line p-6 flex flex-col items-center justify-center space-y-4 shadow-inner">
              ...
              <p className="text-[10px] font-black text-navy/40 uppercase tracking-widest text-center">Escaneie para configurar <br /> o coletor mobile</p>
            </div>
            
            <div className="space-y-3">
              <Button variant="outline" className="w-full h-12 rounded-xl border-line text-navy font-bold text-xs uppercase tracking-widest gap-2 bg-white">
                <Settings className="w-4 h-4" /> Configurações
              </Button>
              <Button variant="ghost" className="w-full h-12 rounded-xl text-muted font-bold text-xs uppercase tracking-widest">
                Ajuda na Recepção
              </Button>
            </div>
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-8 bg-white rounded-[40px] border border-line shadow-sm space-y-4">
          <h3 className="font-manrope font-black text-navy text-xl">Como usar?</h3>
          <ul className="space-y-4">
            <li className="flex gap-4">
              ...
              <p className="text-sm text-muted font-medium">Copie o link acima e envie para os operadores de recepção.</p>
            </li>
            <li className="flex gap-4">
              <span className="w-8 h-8 rounded-full bg-coral/10 text-coral flex items-center justify-center font-black shrink-0">2</span>
              <p className="text-sm text-muted font-medium">Ao acessar, eles poderão selecionar o evento e iniciar o scanner.</p>
            </li>
            <li className="flex gap-4">
              <span className="w-8 h-8 rounded-full bg-coral/10 text-coral flex items-center justify-center font-black shrink-0">3</span>
              <p className="text-sm text-muted font-medium">Todos os dados de check-in serão sincronizados em tempo real com este painel.</p>
            </li>
          </ul>
        </div>
