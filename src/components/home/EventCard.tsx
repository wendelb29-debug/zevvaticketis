  ...
  return (
    <div className="group bg-card border border-border overflow-hidden rounded-lg transition-all duration-300 hover:border-primary/30 hover:shadow-xl">
      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
        ...
        <div className="absolute top-3 left-3 px-3 py-1 bg-card/90 backdrop-blur-md border border-border rounded-md text-[10px] font-bold text-muted-foreground-foreground uppercase tracking-wider">
      ...
      <div className="p-5 space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-1.5 text-muted-foreground-foreground text-xs">
        ...
        <div className="pt-4 flex items-center justify-between border-t border-border">
          <div className="flex flex-col">
            <span className="text-[10px] font-medium text-muted-foreground-foreground">A partir de</span>
