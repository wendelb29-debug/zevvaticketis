...
function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-3xl font-manrope font-extrabold text-navy mb-8 tracking-tighter uppercase">Política de Privacidade</h1>
      <div className="prose prose-slate max-w-none space-y-6 text-muted-fg font-medium">
        ...
        <h2 className="text-xl font-bold text-navy pt-4">1. Coleta de Informações</h2>
        ...
        <h2 className="text-xl font-bold text-navy pt-4">2. Uso de Dados</h2>
        ...
        <h2 className="text-xl font-bold text-navy pt-4">3. Retenção de Dados</h2>
