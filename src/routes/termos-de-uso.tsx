...
function TermsOfUsePage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-3xl font-manrope font-extrabold text-navy mb-8 tracking-tighter uppercase">Termos de Uso</h1>
      <div className="prose prose-slate max-w-none space-y-6 text-muted-fg font-medium">
        ...
        <h2 className="text-xl font-bold text-navy pt-4">1. Licença de Uso</h2>
        ...
        <h2 className="text-xl font-bold text-navy pt-4">2. Isenção de Responsabilidade</h2>
        <p>Os materiais no site do Zevva são fornecidos 'como estão'. O Zevva não oferece garantias, expressas ou implícitas.</p>
        <h2 className="text-xl font-bold text-navy pt-4">3. Integrações de Terceiros</h2>
