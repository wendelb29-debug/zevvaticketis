...
import { ArrowLeft, Mail, Lock, Quote } from 'lucide-react';
...
function LoginPage() {
    ...
    return (<div className="min-h-screen flex bg-white font-inter">
      ...
      <div className="flex-1 flex flex-col p-6 sm:p-12 relative">
        <Button variant="ghost" className="absolute top-8 left-8 text-navy font-bold hover:bg-surface rounded-xl flex items-center gap-2" onClick={() => window.history.back()}>
        ...
        <div className="m-auto w-full max-w-[400px] space-y-10">
          ...
          <div className="space-y-4">
            <Button variant="outline" className="w-full h-14 rounded-[14px] border-slate-200 hover:bg-slate-50 font-bold text-navy flex items-center justify-center gap-3 transition-all" onClick={() => handleSocialLogin('google')}>
              <img src="https://www.google.com/favicon.ico" alt="Google" className="w-5 h-5"/>
              Continuar com Google
            </Button>
            
            <Button className="w-full h-14 rounded-[14px] bg-navy hover:bg-[#1a2035] text-white font-bold flex items-center justify-center gap-3 transition-all" onClick={() => handleSocialLogin('apple')}>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" placeholder="exemplo@email.com" value={email} onChange={(e) => setEmail(e.target.value)} className="h-12 pl-12 rounded-[12px] border-slate-200 focus:border-gold focus:ring-gold/20 font-medium" required/>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="h-12 pl-12 rounded-[12px] border-slate-200 focus:border-gold focus:ring-gold/20 font-medium" required/>
                </div>
              </div>
            </div>
