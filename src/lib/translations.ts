...
export const translations: Record<SupportedLocale, TranslationSchema> = {
  "pt-BR": {
    ...
    home: {
      ...
      faq4Answer: "Sim. Utilizamos tecnologia de ponta para processamento de pagamentos e criptografia de dados, garantizando que sua experiênca seja 100% protegida."
    },
    footer: {
      about: "Sobre a Zevva",
